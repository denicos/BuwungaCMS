...
angular
    .module('homer').controller('BranchCashTransferController', ['$scope', 'ngTableParams', '$http', '$filter', '$location', 'Utils', 'uiGridConstants',
        function ($scope, ngTableParams, $http, $filter, $location, Utils, uiGridConstants) {
            ...
            {
                name: 'Transfer Details', cellTemplate: '<div class="ui-grid-cell-contents"> <a href="#/cashs/' + branchId + '/{{row.entity.CashTransferId}}">Transfer Details</a> </div>',
