...
angular
    ...
    function ($scope, $http, $filter, $location, $log, $timeout, $modal, $state, uiGridConstants, $interval, usSpinnerService) {
        ...
        $scope.Save = function (transactionActivity) {
            ...
            if ($scope.form.$valid) {
                usSpinnerService.spin('global-spinner');
                var promise = $http.post('/webapi/AccountTransactionActivityApi/SaveAdvancedPayment', {
...
angular
    .module('homer').controller('AdvancedPaymentListController', ['$scope', 'ngTableParams', '$http', '$filter', '$location', 'Utils', 'uiGridConstants',
        function ($scope, ngTableParams, $http, $filter, $location, Utils, uiGridConstants) {
            $scope.loadingSpinner = true;
...
angular
    .module('homer').controller('ApprovedDepositsListController', ['$scope', '$http', 'uiGridConstants',
        function ($scope, $http, uiGridConstants) {
            ...
            var promise = $http.get('/webapi/DepositApi/GetLatestTwentyApprovedDepositsForABranch', {});
            promise.then(
                function (payload) {
                    $scope.gridData.data = payload.data;
                    $scope.loadingSpinner = false;
...
angular
    .module('homer').controller('UnApprovedDepositsListController', ['$scope', '$http', 'uiGridConstants',
        function ($scope, $http, uiGridConstants) {
            ...
            var promise = $http.get('/webapi/DepositApi/GetLatestTwentyUnApprovedDepositsForABranch', {});
            promise.then(
                function (payload) {
                    $scope.gridData.data = payload.data;
                    $scope.loadingSpinner = false;
...
angular
    .module('homer').controller('RejectedDepositsListController', ['$scope', '$http', 'uiGridConstants',
        function ($scope, $http, uiGridConstants) {
            ...
            var promise = $http.get('/webapi/DepositApi/GetLatestTwentyRejectedDepositsForABranch', {});
            promise.then(
                function (payload) {
                    $scope.gridData.data = payload.data;
                    $scope.loadingSpinner = false;
