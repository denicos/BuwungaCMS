 ...
 public   class StoreService : IStoreService
    {
        ...
        public long GetAStoreForAParticularBranch(long branchId)
        {
            var store = new Store();
            List<Store> newResults = new List<Store>();
            var results = this._dataService.GetAllStoresForAParticularBranch(branchId);
            newResults = MapEFToModel(results).ToList();
            store = newResults.FirstOrDefault();
        ...
        public long SaveStore(Store store, string userId)
        {
            var storeDTO = new DTO.StoreDTO()
            {
                ...
                OutSourcerId = store.OutSourcerId,
