...
namespace Higgs.Mbale.Web.Controllers
{
    public class DeliveryApiController : ApiController
    {
            ...
            [HttpGet]
            [ActionName("GetAllUnApprovedDeliveries")]
            ...
            {
                return _deliveryService.GetAllApprovedDeliveries();
            }
            [HttpGet]
            [ActionName("GetAllRejectedDeliveries")]
            public IEnumerable<Delivery> GetAllRejectedDeliveries()
            {
                return _deliveryService.GetAllRejectedDeliveries();
            }
                [HttpGet]
